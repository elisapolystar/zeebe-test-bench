...
object CollectMoney {
    ...
    fun main(args: Array<String>) {
        ...
        val jobType = "collect-money"
        clientBuilder.build().use { client ->
            println("Opening job worker for collecting money.")
            client
                .newWorker()
                .jobType(jobType)
                .handler(CollectMoneyHandler())
                .timeout(Duration.ofSeconds(10))
                .open().use {
                    println("Collecting money job worker is opened.")
    ...
    private class CollectMoneyHandler : JobHandler {
